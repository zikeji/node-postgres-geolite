...
module.exports = {
  ...
  getASNv4: (t, ip) => t.oneOrNone('SELECT asn, org FROM geolite_asn WHERE $1::inet BETWEEN ip_start AND ip_end', ip),
  getASNv6: (t, ip) => t.oneOrNone('SELECT asn, org FROM geolite_asn_ipv6 WHERE $1::inet <<= network', ip),
};