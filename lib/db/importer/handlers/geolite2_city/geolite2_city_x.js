...
module.exports = (db, config, proto, path_ips) => new Promise((resolve, reject) => {
  ...
  CREATE TABLE ${dbname}_new (network cidr, geoname_id int, registered_country_geoname_id int, represented_country_geoname_id int, postal_code varchar(10), latitude decimal, longitude decimal);
